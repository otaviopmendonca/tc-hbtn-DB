...
public class MongoDBConnection {
    ...
    private static final String USERNAME = "otaviopedrosomendonca";
    private static final String PASSWORD = "FWh51idR5d9SbWqU";
    private static final String CLUSTER_URL = "cluster0.7xxlfpr.mongodb.net"; // Substitua pelo seu cluster se for diferente
